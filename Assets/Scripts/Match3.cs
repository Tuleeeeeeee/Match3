...
public class Match3 : MonoBehaviour
{
    ...
    public void SetLevelSO(LevelSO levelSO)
    {
        ...
        grid = new Grid<GemGridPosition>(gridWidth, gridHeight, 1f, Vector3.zero,
        (Grid<GemGridPosition> g, int x, int y) => new GemGridPosition(g, x, y));
    ...
    public List<PossibleMove> GetAllPossibleMoves()
    {
        ...
        for (int y = 0; y < gridHeight; y++)
        {
            for (int x = 0; x < gridWidth; x++)
            {
                ...
                {
                    new PossibleMove(x, y, x - 1, y + 0),
                    new PossibleMove(x, y, x + 1, y + 0),
                    new PossibleMove(x, y, x + 0, y + 1),
                    new PossibleMove(x, y, x + 0, y - 1)
                };
...
public class OnLevelSetEventArgs
{
    public LevelSO levelSO;
    public Grid<GemGridPosition> grid;
}

public class OnNewGemGridSpawnedEventArgs
{
